...
      <div className="md:w-1/2 p-6 flex flex-col gap-4"> {/* Changed from justify-between gap-1 to gap-4 for better vertical spacing */}
...
          {/* Removed -mt-30 */}
          <span className="text-sm text-white/80 font-medium font-sans">{author}</span>
